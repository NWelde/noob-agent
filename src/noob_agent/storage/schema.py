...
Version 5 adds nullable `request_options_json` and `tool_call_json` columns to
model_call (`hackathon_plan.md` section 22). Version 4 was used by unmerged
local work that added a `sequence_summary` table, so databases at 3 or 4 both
upgrade by gaining the columns; any extra table they carry is left untouched.
"""
...
ADDED_COLUMNS: tuple[tuple[str, str, str], ...] = (
    ("model_call", "request_options_json", "TEXT"),
    ("model_call", "tool_call_json", "TEXT"),
)
